						...
						<ul class="submenu_list">
							...
							<li><a
								href="${pageContext.request.contextPath}/match/matchList.ma">매치
									찾기</a></li>
							<li><a
								href="${pageContext.request.contextPath}/match/mainList.ma">진행예정
									매치</a></li>
						</ul></li>
					<li class="titlemenu"><a class="title"
...
<!-- 		</div> -->
	...
	<div id="main">
		<div id="billboard">
			<div class="slide">
				<img
					src="${pageContext.request.contextPath}/resources/img/index/slogan2.png"
					alt="slogan2"> <img
					src="${pageContext.request.contextPath}/resources/img/index/slogan3.png"
					alt="slogan3"> <img
					src="${pageContext.request.contextPath}/resources/img/index/match1.png"
					alt="match1"> <img
					src="${pageContext.request.contextPath}/resources/img/index/join.png"
					alt="join"> <img
					src="${pageContext.request.contextPath}/resources/img/index/slogan1.png"
					alt="slogan1"> <img
					src="${pageContext.request.contextPath}/resources/img/index/slogan2.png"
					alt="slogan2">
			</div>
		        ...
		        for(let i=0; i<data.length; i++) {     
		        	...
		        	//console.log(content);									
						content += "<tr>"
								...
								+   "<td style='padding: 10px 0;'>" + data[i].alarmMsg + "</td>";
							if(data[i].alarmStatus == 0) {
						content	+= 	"<td>"
								+	"</td>";
							} else if(data[i].alarmStatus == 1) {
						content	+= 	"<td>"
								+		"<button type='button' style='align:right; width:50px;' onclick='pay(`"+ data[i].no +"`);'>결제</button>"
								+	"</td>"	;
							} else if(data[i].alarmStatus == 2) {						
						content	+= 	"<td>"
								+		"<button type='button' style='width:50px;' onclick='accept(`"+ data[i].no +"`);'>수락</button>"
								+		"<button type='button' style='align:right; width:50px;' onclick='reject(`"+ data[i].no +"`);'>거절</button>"
								+	"</td>"		;					
							}
						content	+=  "</tr>";
