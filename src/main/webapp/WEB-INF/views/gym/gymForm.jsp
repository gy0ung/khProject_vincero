...
<link rel="stylesheet"
   href="${pageContext.request.contextPath}/resources/css/gym/gym.css">
	<jsp:include page="/WEB-INF/views/common/header.jsp">
      <jsp:param value="빈체로/관장 - ${gym.gymCoach}님 체육관 정보" name="title" />
  	</jsp:include>
...
<div style="display: flex; justify-content: center;">
	...
	<table class="container" style="float:right;" id="table2">
		...
		<tr>
			<td colspan="2" align="center">
				<button class="button" type="button" onclick="gymUpdate('${gym.userId}');">수정하기</button>
			</td>
		</tr>
	</table>
	</form>	
...
<script>
	function gymUpdate(userId) {
		location.href='${pageContext.request.contextPath}/gym/gymUpdate.gym?userId='+userId;
	}
</script>
