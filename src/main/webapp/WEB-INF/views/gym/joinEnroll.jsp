...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/gym/joinEnroll.css?v=<%=System.currentTimeMillis()%>">
</head>
<body>
	...
	<script>
	function gymForm() {
		location.href="${pageContext.request.contextPath}/gym/gymForm.gym";
	}
	function gymSchedule() {
		location.href="${pageContext.request.contextPath}/gym/matchList.gym";
	}
	</script>
	
	<div id="joinEnroll">
		<div id="joinEnroll_describe">
			<h1>- 가맹점 신청 -</h1>
		...
		<div id="joinEnroll_joinPart">
			<div id="image">
				<img src="${pageContext.request.contextPath}/resources/img/gym/taekwon.jpg" alt="taekwondo" width="650px" height="650px">
			</div>
			<div id="table">
				<form action="${pageContext.request.contextPath}/gym/joinEnrollForm.gym" name="joinForm" method="post">
					<table>
						...
						<tr>
							<th>
								<label for="gymBoss">사업자대표&emsp;:&emsp;</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="coachPhone">관장님전화&emsp;:&emsp;</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="gymPhone">체육관전화&emsp;:&emsp;</label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="gymZipcode">체육관우편&emsp;:&emsp; </label>
							</th>
							<td>
						...
						<tr>
							<th>
								<label for="gymDetailaddress">상세주소란&emsp;:&emsp;</label>
							</th>
							<td>
