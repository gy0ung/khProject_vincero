...
<body>
	<jsp:include page="/WEB-INF/views/common/header.jsp">
      <jsp:param value="빈체로/관장 - ${gym.gymCoach}님 체육관 정보수정" name="title" />
  	</jsp:include>
	...
	<!-- 체육관정보 리스트 테이블 -->
		...
		<table class="container" style="float:right;" id="table2">
			...
			<tr>
				<th>체육관 번호</th>
				<td>
					<input type="text" id="gymPhone" name="gymPhone" style="width: 130px;" value="${gym.gymPhone}">
				</td>
			</tr>
			<tr>
				<th>체육관 우편번호</th>
				<td>
					...
					<button class="button" style="float:left;margin-left:15px;" onclick="findAddr();">찾기</button>
				</td>
			</tr>
			<tr>
				<th>체육관 주소</th>
			...
			<tr>
				<td colspan="2" align="center">
					...
					&emsp;
					<button class="button" type="reset">원래대로</button>
				</td>
			</tr>
		</table>
		<!--  
